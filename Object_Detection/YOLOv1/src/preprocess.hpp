...
// ----------------------------------------------------
// class{YOLOPreprocess}(transforms::Compose)
// ----------------------------------------------------
class YOLOPreprocess : public transforms::Compose{
private:
...
public:
    YOLOPreprocess(const double flip_rate_=0.5, const double scale_rate_=0.5, const double blur_rate_=0.5, const double brightness_rate_=0.5, const double hue_rate_=0.5, const double saturation_rate_=0.5, const double shift_rate_=0.5, const double crop_rate_=0.5);
