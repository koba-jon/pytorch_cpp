...
// ----------------------------------------------------------------------
// struct{MC_VGGImpl}(nn::Module) -> constructor
// ----------------------------------------------------------------------
MC_VGGImpl::MC_VGGImpl(po::variables_map &vm){
...
// ---------------------------------------------------------
// struct{MC_VGGImpl}(nn::Module) -> function{init}
// ---------------------------------------------------------
void MC_VGGImpl::init(){
...
// ---------------------------------------------------------
// struct{MC_VGGImpl}(nn::Module) -> function{forward}
// ---------------------------------------------------------
torch::Tensor MC_VGGImpl::forward(torch::Tensor x){
