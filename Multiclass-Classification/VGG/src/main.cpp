...
void test(po::variables_map &vm, torch::Device &device, MC_VGG &model, std::vector<transforms::Compose*> &transform, const std::vector<std::string> class_names);
