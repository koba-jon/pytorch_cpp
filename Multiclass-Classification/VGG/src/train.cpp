...
// Function Prototype
void valid(po::variables_map &vm, DataLoader::ImageFolderClassesWithPaths &valid_dataloader, torch::Device &device, Loss &criterion, MC_VGG &model, const std::vector<std::string> class_names, const size_t epoch, visualizer::graph &writer, visualizer::graph &writer_accuracy, visualizer::graph &writer_each_accuracy);


// -------------------
// Training Function
// -------------------
void train(po::variables_map &vm, torch::Device &device, MC_VGG &model, std::vector<transforms::Compose*> &transform, const std::vector<std::string> class_names){
