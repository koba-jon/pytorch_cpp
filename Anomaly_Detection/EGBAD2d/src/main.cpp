...
po::options_description parse_arguments(){
    ...
    args.add_options()
        ...
        ("E_ltw", po::value<float>()->default_value(0.5), "the weight of loss threshold for stable training in encoder : x=0.0 is normal training")
        ...
        ("nef", po::value<size_t>()->default_value(64), "the number of filters in convolution layer closest to image in encoder")
...
int main(int argc, const char *argv[]){
    ...
    // (5) Define Network
    GAN_Encoder enc(vm); enc->to(device);
