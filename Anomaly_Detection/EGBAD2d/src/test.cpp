...
// Function Prototype
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> AnomalyScore(torch::Tensor image, torch::Tensor fake_image, torch::Tensor z, GAN_Discriminator &dis, const float Lambda=0.1);


// ---------------
// Test Function
// ---------------
void test(po::variables_map &vm, torch::Device &device, GAN_Encoder &enc, GAN_Generator &gen, GAN_Discriminator &dis, std::vector<transforms::Compose*> &transform){
...
// ---------------------------------------------
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> AnomalyScore(torch::Tensor image, torch::Tensor fake_image, torch::Tensor z, GAN_Discriminator &dis, const float Lambda){
