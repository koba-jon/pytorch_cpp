...
void valid(po::variables_map &vm, DataLoader::ImageFolderPairWithPaths &valid_dataloader, torch::Device &device, Loss &criterion_GAN, torch::nn::MSELoss &criterion_Con, SRGAN_Generator &gen, SRGAN_Discriminator &dis, MC_VGGNet &vgg, const size_t epoch, visualizer::graph &writer, visualizer::graph &writer_gen, visualizer::graph &writer_dis){
    ...
    torch::Tensor G_content_loss, G_GAN_loss;
    ...
    dis->eval();
    iteration = 0;
    total_G_GAN_loss = 0.0; total_G_content_loss = 0.0; total_dis_real_loss = 0.0; total_dis_fake_loss = 0.0;
    ...
    writer.plot(/*base=*/epoch, /*value=*/{ave_G_GAN_loss + ave_G_content_loss, ave_dis_real_loss + ave_dis_fake_loss});
    writer_gen.plot(/*base=*/epoch, /*value=*/{ave_G_GAN_loss + ave_G_content_loss, ave_G_GAN_loss, ave_G_content_loss});
