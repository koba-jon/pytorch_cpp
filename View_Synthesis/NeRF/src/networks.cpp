...
// ---------------------------------------------
NeRFImpl::NeRFImpl(po::variables_map &vm, torch::Device device){
...
// -----------------------------------------------------
// struct{NeRFImpl}(nn::Module) -> function{add_noise}
// -----------------------------------------------------
std::tuple<torch::Tensor, torch::Tensor> NeRFImpl::add_noise(torch::Tensor x_0, torch::Tensor t){
...
// ---------------------------------------------------
// struct{NeRFImpl}(nn::Module) -> function{denoise}
// ---------------------------------------------------
torch::Tensor NeRFImpl::denoise(torch::Tensor x_t, torch::Tensor t){
...
// -----------------------------------------------------
// struct{NeRFImpl}(nn::Module) -> function{denoise_t}
// -----------------------------------------------------
torch::Tensor NeRFImpl::denoise_t(torch::Tensor x_t, torch::Tensor t){
...
// ---------------------------------------------------
torch::Tensor NeRFImpl::forward(torch::Tensor x_t, torch::Tensor t){
...
// -----------------------------------------------------
// struct{NeRFImpl}(nn::Module) -> function{forward_z}
// -----------------------------------------------------
torch::Tensor NeRFImpl::forward_z(torch::Tensor z){
    torch::Tensor x, t;
    x = z;
