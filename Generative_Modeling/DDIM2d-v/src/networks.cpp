...
// ---------------------------------------------
// struct{DDIMImpl}(nn::Module) -> constructor
// ---------------------------------------------
DDIMImpl::DDIMImpl(po::variables_map &vm, torch::Device device){
...
// -----------------------------------------------------
// struct{DDIMImpl}(nn::Module) -> function{add_noise}
// -----------------------------------------------------
std::tuple<torch::Tensor, torch::Tensor> DDIMImpl::add_noise(torch::Tensor x_0, torch::Tensor t){
...
// ---------------------------------------------------
// struct{DDIMImpl}(nn::Module) -> function{denoise}
// ---------------------------------------------------
torch::Tensor DDIMImpl::denoise(torch::Tensor x_t, torch::Tensor t, torch::Tensor t_prev){
    ...
    out = torch::sqrt(alpha_bar_prev) * x_0 + torch::sqrt(1.0 - alpha_bar_prev - sigma * sigma) * eps + sigma * noise;
...
// ---------------------------------------------------
torch::Tensor DDIMImpl::forward(torch::Tensor x_t, torch::Tensor t){
...
// -----------------------------------------------------
// struct{DDIMImpl}(nn::Module) -> function{forward_z}
// -----------------------------------------------------
torch::Tensor DDIMImpl::forward_z(torch::Tensor z){
