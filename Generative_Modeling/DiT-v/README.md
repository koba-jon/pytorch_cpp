# DiT-v
This is the implementation of "Diffusion Transformer" based on v-prediction for high resolution.<br>
Original paper: W. Peebles and S. Xie. Scalable Diffusion Models with Transformers. In Proceedings of the IEEE/CVF International Conference on Computer Vision, 2023. [link](https://openaccess.thecvf.com/content/ICCV2023/html/Peebles_Scalable_Diffusion_Models_with_Transformers_ICCV_2023_paper.html)
