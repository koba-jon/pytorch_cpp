...
// -----------------------------------
// class{Loss_PixelCNN} -> constructor
// -----------------------------------
Loss_PixelCNN::Loss_PixelCNN(const long int K_){
    this->K = K_;
}


// -----------------------------------
// class{Loss_PixelCNN} -> operator
// -----------------------------------
torch::Tensor Loss_PixelCNN::operator()(torch::Tensor &input, torch::Tensor &target){
