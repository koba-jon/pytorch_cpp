...
// Function Prototype
void valid(po::variables_map &vm, DataLoader::ImageFolderSegmentWithPaths &valid_dataloader, torch::Device &device, Loss &criterion, SegNet &model, const size_t epoch, visualizer::graph &writer);
