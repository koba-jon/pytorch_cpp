...
void test(po::variables_map &vm, torch::Device &device, ViT &model, std::vector<transforms_Compose> &transform, const std::vector<std::string> class_names);
...
po::options_description parse_arguments(){
    ...
    args.add_options()
        ...
        ("split", po::value<size_t>()->default_value(8), "number of split : patch_size(32) = size(256) / split(8)")
        ...
        ("dim", po::value<size_t>()->default_value(1024), "dimensions of the embedded patch features")
        ("depth", po::value<size_t>()->default_value(6), "the number of layer in Transformer")
        ("heads", po::value<size_t>()->default_value(16), "the number of head in Transformer")
        ("dim_head", po::value<size_t>()->default_value(64), "dimensions of the head")
        ("mlp_dim", po::value<size_t>()->default_value(2048), "dimensions in multi layer perceptron")
