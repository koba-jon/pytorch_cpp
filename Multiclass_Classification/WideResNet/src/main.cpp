...
void test(po::variables_map &vm, torch::Device &device, MC_WideResNet &model, std::vector<transforms_Compose> &transform, const std::vector<std::string> class_names);
...
int main(int argc, const char *argv[]){
    ...
    Set_Model_Params(vm, model, "WideResNet");
