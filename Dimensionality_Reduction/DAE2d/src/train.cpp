...
// Function Prototype
void valid(po::variables_map &vm, DataLoader::ImageFolderPairWithPaths &valid_dataloader, torch::Device &device, Loss &criterion, ConvolutionalAutoEncoder &model, const size_t epoch, visualizer::graph &writer);
