...
namespace DataLoader{
    ...
    // -----------------------------------------------------
    // namespace{DataLoader} -> class{ImageTensorFolderPairWithPaths}
    // -----------------------------------------------------
    ...
    public:
        ...
        ImageTensorFolderPairWithPaths(datasets::ImageTensorFolderPairWithPaths &dataset_, const size_t batch_size_=1, const bool shuffle_=false, const size_t num_workers_=0, const bool pin_memory_=false, const bool drop_last_=false);
        bool operator()(std::tuple<torch::Tensor, torch::Tensor, std::vector<std::string>, std::vector<std::string>> &data);
        void reset();
        size_t get_count_max();
    };
    ...
    // ----------------------------------------------------------------
    // namespace{DataLoader} -> class{ImageFolderCameraPoseWithPaths}
    // ----------------------------------------------------------------
    ...
    public:
        ...
        ImageFolderCameraPoseWithPaths(datasets::ImageFolderCameraPoseWithPaths &dataset_, const size_t batch_size_=1, const bool shuffle_=false, const size_t num_workers_=0, const bool pin_memory_=false, const bool drop_last_=false);
        bool operator()(std::tuple<torch::Tensor, torch::Tensor, std::vector<std::string>, std::vector<std::string>> &data);
        void reset();
        size_t get_count_max();
    };
